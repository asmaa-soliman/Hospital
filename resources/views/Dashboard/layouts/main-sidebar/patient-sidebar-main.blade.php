...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">{{trans('main-sidebars.main')}}</li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('list.doctors')}}"> الأطباء</a></li>
                    <li><a class="slide-item" href="{{route('chat.doctors')}}">المحادثات الأخيره</a></li>
                </ul>
            </li>
        </ul>
    </div>
