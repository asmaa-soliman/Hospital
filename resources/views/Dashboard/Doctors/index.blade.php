                            ...
                            <tbody>
                                @foreach ($doctors as $doctor)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" name="delete_select"  class="delete_select" value="{{ $doctor->id }}">
                                        </td>
                                        <td>{{ $doctor->name }}</td>
                                        <td>
                                            @if ($doctor->image)
                                        ...
                                        <td>
                                            {{-- بنوقفه علشان ماينفعش احذف الدكتور لانه مرتبط بحاجات تانيه --}}
...
@section('js')
    ...
    {{-- display model al 7zef and gwt id --}}
