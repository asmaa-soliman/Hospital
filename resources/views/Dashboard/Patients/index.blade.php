								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												<th>#</th>
												<th>{{ trans('Dashboard/main-sidebar_trans.patient name') }} </th>
												<th >{{ trans('Dashboard/main-sidebar_trans.e-mail') }} </th>
												<th>{{ trans('Dashboard/main-sidebar_trans.date-of-birth') }}</th>
												<th>{{ trans('Dashboard/main-sidebar_trans.phone') }}</th>
												<th>{{ trans('Dashboard/main-sidebar_trans.gender') }}</th>
                                                <th >{{ trans('Dashboard/main-sidebar_trans.blood-type') }}</th>
                                                <th >{{ trans('Dashboard/main-sidebar_trans.title') }}</th>
                                                <th>{{ trans('Dashboard/main-sidebar_trans.process') }}</th>
											</tr>
										</thead>
										<tbody>
