...
@section('title')
    {{trans('main-sidebars.single_service')}}
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('main-sidebars.services')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('main-sidebars.single_service')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{$service->status == 1 ? trans('doctors.enabled'):trans('doctors.disabled')}}
                                    </td>
