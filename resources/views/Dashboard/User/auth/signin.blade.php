                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            @endif
											{{-- end error message if data wrong --}}
                                            ...
                                            <div class="loginform" id="admin">
                                                <h5 class="font-weight-semibold mb-4"> الدخول الادمن</h5>
                                              ...
                                              <div class="loginform" id="doctor">
                                                <h5 class="font-weight-semibold mb-4">دخول الدكتور!</h5>
...
@endsection
@section('js')
    {{-- اظهر فورم الادمن او اليوزر لما الضغط عليها  --}}
    <script>
