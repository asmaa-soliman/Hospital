...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> Pages </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> {{ trans ('Dashboard/main-sidebar_trans.view_all') }} </span>
						</div>
					</div>
...
<script src="{{URL::asset('Dashboard/plugins/datatable/js/responsive.bootstrap4.min.js')}}"></script>
 ...
 <!--Internal  Notify js to use java script in message alert -->
