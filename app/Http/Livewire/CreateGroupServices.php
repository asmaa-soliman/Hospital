...
class CreateGroupServices extends Component
{
    ...
    public function edit($id)
    {
        ...
        foreach ($group->pivot_service_group as $pivotServiceGroup)
        {
            $this->GroupsItems[] = [
                'service_id' => $pivotServiceGroup->id,
                'quantity' => $pivotServiceGroup->pivot->quantity,
                'is_saved' => true,
                'service_name' => $pivotServiceGroup->name,
                'service_price' => $pivotServiceGroup->price
            ];
        }
    }
