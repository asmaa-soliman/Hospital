            ...
            try {
                ...
                // في حالة الاضافة
                    ...
                    $this->show_table =true;
                     ...
                     $appointment_info = Appointment::where('doctor_id', $this->doctor_id)->where('email', $patient->email)->where('type','confirmed')->first();
                     if ($appointment_info) {
                    ...
                    // make var to use it in myevent(push)
                    $data=[
                        'patient'=>$this->patient_id,
                        'invoice_id'=>$single_invoices->id,
                        'doctor_id'=>$this->doctor_id,
                    ];
                    // make event push to real data
